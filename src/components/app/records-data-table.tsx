  ...
  <TableBody>
    {sortedAndFilteredRecords.length > 0 ? (
      (() => {
        ...
        return sortedAndFilteredRecords.map((record) => {
          ...
          return (
            <TableRow key={record.id} className={cn(record.isKeyRecord && 'bg-primary/10 hover:bg-primary/20')}>
              ...
              <TableCell className={cn("text-right font-mono font-semibold", snapshot > 0 ? 'text-destructive' : snapshot < 0 ? 'text-green-600 dark:text-green-500' : 'text-muted-foreground')}>
